...
parser = argparse.ArgumentParser(description='In progress model training script',add_help=True)
parser.add_argument("--gpuid", default=1, type=int, help="GPU to use (0-3)")
parser.add_argument("--datadir", default="../../data/preprocessed/", help="Path to data hdf5 file")
parser.add_argument("--holdout", type=int, default=5, help="subset of data to skip during training.")
parser.add_argument("--batchsize", type=int, default=64, help="The batch size to use")
...
print("HDF path_to_hdf5 : " + path_to_hdf5)

# Save Keras model to this file
CHECKPOINT_FILENAME = "./resnet_3d_64_64_64_HOLDOUT{}".format(HOLDOUT_SUBSET) + time.strftime("_%Y%m%d_%H%M%S") + ".hdf5"
